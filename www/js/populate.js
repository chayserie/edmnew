...
$.each(busemenu,function(i,data){
	$("#buse-menu").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(lusemenu,function(i,data){
	$("#luse-menu").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(occupants,function(i,data){
	$("#numOcc-menu").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(roofmaterial,function(i,data){
	$("#roofMat-menu").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(roofpitch,function(i,data){
	$("#rPitch-menu").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(wallmaterial,function(i,data){
	$("#wallMat-menu").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(floorelev,function(i,data){
	$("#fElev-menu").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(basement,function(i,data){
	$("#numBase-menu").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(foundation,function(i,data){
	$("#fType-menu").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(maxflood,function(i,data){
	$("#Maxflood").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(windowtype,function(i,data){
	$("#Wtype").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(yearbuilt,function(i,data){
	$("#ybuilt").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(buildingtype,function(i,data){
	$("#btype").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(vertical,function(i,data){
	$("#vshape").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(horizontal,function(i,data){
	$("#hshape").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(buildingwidth,function(i,data){
	$("#bwidth").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(buildingdepth,function(i,data){
	$("#bdepth").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(bcondition,function(i,data){
	$("#bcondition").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(roof,function(i,data){
	$("#rfmaterial").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(bracing,function(i,data){
	$("#brmaterial").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(beam,function(i,data){
	$("#bmmaterial").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(column,function(i,data){
	$("#clmaterial").append("<option value='" + data + "'>" + data + "</option>");
});
$.each(structure,function(i,data){
	$("#stype").append("<option value='" + data + "'>" + data + "</option>");
});
